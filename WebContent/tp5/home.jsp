		...
		<section class="uk-section">
			<div class="uk-container uk-container-small">
                ...
                <h1 class="uk-heading-small">Accueil</h1>
             	...
             	<p style="color: ${ colorTheme }">Vous êtes venu ${ compteur } fois</p>
             	
             	<form action="/SuiviRepas/home-tp5-servlet" method="post">
             	
             	 <label class="uk-form-label">Couleur</label>
			        <div class="uk-form-controls">
		             	<select name="selectedColor" class="uk-select" >
			             	<c:forEach var="entry" items="${colors}">
