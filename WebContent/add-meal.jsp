    ...
    <body>
        ...
        <section class="uk-section">
            <div class="uk-container uk-container-small">
                ...
                <h1 class="uk-heading-small">Ajouter un repas</h1>

                <!-- Formulaire -->
                <form method="post" action="/SuiviRepas/add-meal">
                    <!-- Champ Date  -->
                    <div class="uk-margin">
                        <input class="uk-input" type="date" name="date" placeholder="Date" aria-label="Date" value="" />
                    </div>

                    <!-- Champ Heure -->
                    <div class="uk-margin">
                        <input class="uk-input" type="text" name="hour" placeholder="Heure" aria-label="Heure" value="" />
                    </div>

                    <!-- Champ Aliments  -->
                    <div class="uk-margin">
                        <input class="uk-input" type="text" name="aliments" placeholder="Aliments" aria-label="Aliments" value="" />
                    </div>

                    <!-- Bouton de validation  -->
                    <div class="uk-margin">
                        <input class="uk-button uk-button-default" type="submit" value="Enregistrer" />
                    </div>
                </form>
        ...
        <div id="offcanvas-nav" data-uk-offcanvas="flip: true; overlay: true">
            <div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
                ...
                <ul class="uk-nav uk-nav-default">
                    ...
                    <li><a href="#"><span class="uk-margin-small-right uk-icon" data-uk-icon="icon: trash"></span>
                            Item</a></li>
                </ul>
                <h3>Title</h3>
